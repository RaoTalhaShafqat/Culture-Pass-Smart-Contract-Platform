...
contract CulturePassAdmin is Test {
    ...
    function testRegisterVenueOnly() public {
        ...
        cPass.registerVenue(1, "Louvre Museum", address(0x123), CulturePass.Category.Museum, 1 ether, 100);
    ...
    function testRegisterVenueInvalidWallet() public {
        ...
        cPass.registerVenue(1, "Louvre Museum", address(0), CulturePass.Category.Museum, 1 ether, 100);
    }
    ...
    function testRegisterVenueInvalidEntryPrice() public {
        ...
        cPass.registerVenue(1, "Louvre Museum", address(0x123), CulturePass.Category.Museum, 0, 100);
    }
    ...
    function testRegisterVenueInvalidDailyCapacity() public {
        ...
        cPass.registerVenue(1, "Louvre Museum", address(0x123), CulturePass.Category.Museum, 1 ether, 0);
    }
    ...
    function testRegisterVenueInvalidName() public {
        ...
        cPass.registerVenue(1, "", address(0x123), CulturePass.Category.Museum, 1 ether, 100);
    }
    ...
    function testRegisterVenueInvalidCategory() public {
        ...
        cPass.registerVenue(1, "Louvre Museum", address(0x123), CulturePass.Category.None, 1 ether, 100);
    }
    ...
    function testRegisterVenueDuplicate() public {
        ...
        cPass.registerVenue(1, "Another Venue", address(0x124), CulturePass.Category.Theater, 2 ether, 50);
    }
    ...
    function testsetPassTier() public {
        ...
        (uint256 monthlyTickets, uint256 priceETH, uint256 monthlyVisitCap) =
